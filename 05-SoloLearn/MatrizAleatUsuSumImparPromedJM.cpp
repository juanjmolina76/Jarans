...
void SumParImparMatriz (int ma [][N],int fil, int col);
...
void SumParImparMatriz (int ma [][N],int fil, int col)
{
int sumaPar=0,sumaImpar=0,contP=0,contI=0;
for (int i=0; i<fil;i++)
{
    for (int j=0; j<col;j++)
    {
...
cout<<"el promedio de los pares es :"<<sumaImpar / contI<<endl;
