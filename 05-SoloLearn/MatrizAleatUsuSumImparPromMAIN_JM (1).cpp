...
void  MayorMenorDeFila ( int ma [][N], int fil, int col);


int main ()
{
    int num, ma[N][N]; 
    int fil,col,contP=0,contI=0,sumaPar=0,sumaImpar=0, mayor=0,menor=1;
...
/*int max=0, min=0;
    for(int i=0; i<fil; i++){        
        ...
        cout<<"Mayor de la fila "<<i<<": "<<max<<endl;
        cout<<"Mewnor de la fila "<<i<<": "<<min<<endl;
    }*/